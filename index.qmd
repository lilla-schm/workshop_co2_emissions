...
emissions_long_subset = emissions_long.query('country.isin(["Hungary", "Germany", "Australia", "France", "Brazil"])')
...
fig_chart = px.line(
    ...
    y='emissions',
    color='country',
    title='CO2 emission (1990-2020)',
    labels={'emissions': 'CO2 emissions in tons', 'country': '', 'year' : 'Year'} )
